...
<body class="bg-light">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="btn-group">
                  ...
                  <button type="button" class="btn"><a href="?action=quanly-user"style="color: white;">Quản lý thành viên</a></button>
    ...
    <div class="container" style="margin-top: 10px;">
        <div class="row" class="manager-user">
            <div class="col-sm-12">
                <table style="width: 100%;">
                <tr style="background-color: green;border: solid 1px black; padding:20px auto;">
                    <th>STT</th>
                ...
                while($row= mysqli_fetch_assoc($data)){
                    ...
                    <tr style="border: solid 1px black;">
                        ...
                        <td>
                            <a href="?action=taikhoanuser&userid=<?php echo $row['id'];?>">Xem</a>
                        </td>
                        <td>
                            <a href="?action=Delete_user&id=<?php echo $row['id'];?>">Delete</a>
                        </td>  
                    </tr>
                    <?php 
                    $stt++;
