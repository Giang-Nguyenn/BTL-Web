...
<head>
    ...
    <title>User_view_product</title>
</head>
<body class="bg-light">
    <?php include"user_header.php" ?>
    <!-- <?php echo $_SESSION['idproduct'] ?> -->
        ...
        <div class="row" style="border: 1px solid orange;">
            ...
            <div class="col-sm-6 product-infor">
                ...
                <div class="product-describe">
                    <p style="margin: 10px 0;"><?php echo $describe?></p>
                </div>
    ...
    <div class="container list_comment">
        <div class="row" id="comment" class="comment">
            <form class="col-sm-12 comment" action="?action=insert_comment&id=<?php echo $id;  ?>" method="POST">
                <input type="text" name="comment_text" placeholder="Bình luận..." onclick="document.getElementById('submit').style.display='block'" id="input_comment">
                <input type="submit" name="comment" id="submit" value="Comment">
            </form>
        </div>
    ...
    <script>
        //nếu đã đăng nhập thì hiện hộp comment
        if(<?php echo $_SESSION['status']  ?>==0)
        {
            document.getElementById('comment').style.display='none';
        }
        //hiệu ứng xem sản phẩm    
        var a=1;
        function prevnext(x){
            a=a+x;
            showslide(a);
